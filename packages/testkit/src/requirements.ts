...
export const SPREADSHEET_REQUIREMENTS = defineRequirementManifest([
  ...
  requirement("XLSX-CELL-STYLES", "§18.8.1–45", "spreadsheet.styles", ["styles.test.ts", "styles.property.test.ts", "formatting.test.ts", "formatting.property.test.ts", "worksheet.test.ts", "spreadsheet-cell-style.test.ts"], { render: "partial", preserve: "supported", edit: "partial", write: "partial" }),
  ...
  requirement("XLSX-DRAWING-PARTS", "§12.3.8, §18.3.1.36", "spreadsheet.drawings", ["drawings.test.ts", "charts.test.ts"], { recognize: "supported", preserve: "supported", render: "partial" }),
  requirement("XLSX-DRAWING-ANCHORS", "§20.5.2.1, §20.5.2.24, §20.5.2.33", "spreadsheet.drawing-anchors", ["drawing-anchors.test.ts", "spreadsheet-viewport.test.ts"], { recognize: "supported", preserve: "supported", render: "supported" }),
  requirement("XLSX-CHART-PARTS", "§14.2.1, §21.2.2.27, §21.2.2.29", "spreadsheet.charts", ["charts.test.ts", "parser.test.ts", "spreadsheet-viewport.test.ts"], { recognize: "supported", preserve: "supported", render: "partial" }),
  requirement("XLSX-CHART-SERIES", "§21.2.2.65, §21.2.2.120, §21.2.2.123, §21.2.2.199, §21.2.2.201", "spreadsheet.chart-data", ["parser.test.ts", "chart-data.test.ts"], { recognize: "partial", preserve: "supported", render: "partial" }),
