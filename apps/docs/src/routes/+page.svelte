...
<div class="doc-layout">
  ...
  <nav class="contents" aria-label="On this page"><p>On this page</p><a href="#start">Start with a document</a><a href="#formats">Choose a format</a><a href="#model">Application ownership</a></nav>
</div>
