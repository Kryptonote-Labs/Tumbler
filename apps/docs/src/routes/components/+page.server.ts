...
const examples = [
  { id: 'slides', name: 'PresentationSlideView', description: 'PresentationML slides with inherited layouts, text, pictures, shapes, and charts.', hint: 'Choose a slide or pinch to zoom. Open the PowerPoint playground to try editing.', code: slides, props: [['presentation / slide', 'The parsed presentation and active slide.'], ['scale', 'Bindable zoom relative to fit-to-view.'], ['editable / selectedKey', 'Editing interactions and bindable selected object.'], ['onobjectchange / ontextedit', 'Committed geometry or text edits for an artifact or session.']], href: '/docs/powerpoint' },
